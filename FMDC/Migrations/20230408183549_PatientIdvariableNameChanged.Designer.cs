...
namespace FMDC.Migrations
{
    ...
    [Migration("20230408183549_PatientIdvariableNameChanged")]
    partial class PatientIdvariableNameChanged
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Appointment", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Reciept", "Reciept")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Models.Reciept", b =>
                {
                    b.HasOne("Domain.Models.User", "AuthorizeBy")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Models.ReportValue", b =>
                {
                    b.HasOne("Domain.Models.LabReport", null)
                        .WithMany("TestParamValues")
